                            ...
                            ui.vertical(|ui| {
                                ...
                                ui.horizontal(|ui| {
                                    if ui.button(if self.is_running { "⏸ Pause" } else { "▶ Play" })
                                        .on_hover_text("Avvia o metti in pausa la simulazione in tempo reale")
                                        .clicked() {
                        ...
                        ui.group(|ui| {
                            ui.vertical(|ui| {
                                ...
                                if ui.button("📥 Esporta 24h CSV")
                                    .on_hover_text("Esporta i dati di throughput e connettività delle ultime 24 ore in formato CSV")
                                    .clicked() {
